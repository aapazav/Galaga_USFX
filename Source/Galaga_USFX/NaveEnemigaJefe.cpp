...
ANaveEnemigaJefe::ANaveEnemigaJefe()
{
	...
	MallaNaveEnemigaJefe = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("ShipMesh"));
	MallaNaveEnemigaJefe->SetStaticMesh(ShipMesh.Object);
	MallaNaveEnemigaJefe->SetupAttachment(RootComponent);
	RootComponent = MallaNaveEnemigaJefe;
